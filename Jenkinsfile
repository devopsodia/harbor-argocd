...
//   }
    ...
    stage('Publish  Helm') {
        ...
        echo "Packing helm chart"
            ...
            sh "helm registry login devopsodia-harbor.com --username admin --password Harbor12345 --insecure"
            sh "helm registry push ${WORKSPACE}/helm/devopsodia-1.tgz -v devopsodia-harbor.com/chartrepo/argocd-image-helm"
